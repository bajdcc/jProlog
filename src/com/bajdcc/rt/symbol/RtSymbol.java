...
public class RtSymbol {
    ...
    private RtStringFactory strFactory = new RtStringFactory();
    private RtBlockAdvanceStruct adv = new RtBlockAdvanceStruct();
    ...
    public void registerType(String type) throws SemanticException {
        if (!strFactory.add(type, RtStringFactory.ValType.SET)) {
            throw new SemanticException(type, "集合名重复定义", SemanticException.SemanticErrorType.REDECL);
        }
        adv.addSet(new RtSetDef(strFactory.query(type, RtStringFactory.ValType.SET)));
    }
    ...
    public void registerTypeValue(String type, Object value) throws SemanticException {
        RtSetDef set = adv.getSet(strFactory.query(type, RtStringFactory.ValType.SET));
        String val = String.valueOf(value);
        if (value instanceof Integer) {
            set.addInteger(Integer.parseInt(val));
        } else {
            strFactory.add(val, RtStringFactory.ValType.LITERAL);
            set.addLiteral(strFactory.query(val, RtStringFactory.ValType.LITERAL));
        }
    }
    ...
    public void registerSingleVariable(String type, String var) throws SemanticException {
        int id = strFactory.query(type, RtStringFactory.ValType.SET);
        if (strFactory.containsVar(var)) {
            throw new SemanticException(var, "单变量重复定义", SemanticException.SemanticErrorType.REDECL);
        }
        strFactory.add(var, RtStringFactory.ValType.SINGLE);
        adv.addSin(new RtSinVarDef(strFactory.query(var, RtStringFactory.ValType.SINGLE), id));
    }
    ...
    public void registerSequenceVariable(String type, String var) throws SemanticException {
        ...
        strFactory.add(var, RtStringFactory.ValType.SEQUENCE);
        adv.addSeq(new RtSeqVarDef(strFactory.query(var, RtStringFactory.ValType.SEQUENCE), id));
    }
    ...
    public void registerArgumentVariable(String type, String var) throws SemanticException {
        ...
        strFactory.add(var, RtStringFactory.ValType.ARGUMENT);
        adv.addArg(new RtArgVarDef(strFactory.query(var, RtStringFactory.ValType.ARGUMENT), id));
    }
    ...
    public void registerArgumentVariableType(String type, String var) throws SemanticException {
        RtArgVarDef arg = adv.getArg(strFactory.query(var, RtStringFactory.ValType.ARGUMENT));
        arg.add(strFactory.query(type, RtStringFactory.ValType.SET));
    }
    ...
    public void registerLiteral(String literal) throws SemanticException {
        strFactory.add(literal, RtStringFactory.ValType.LITERAL);
    }
    ...
    public void registerTmpVar(String var) throws SemanticException {
        ...
        strFactory.add(var, RtStringFactory.ValType.TMPID);
    }
     ...
     */
    public int query(String str, RtStringFactory.ValType val) throws SemanticException {
